intellisense.annotate(jQuery, {
  ...
  'browser._version': function() {
    /// <summary>The _version number of the rendering engine for the user's browser. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
...
intellisense.annotate(jQuery.fn, {
  ...
  'jquery': function() {
    /// <summary>A string containing the jQuery _version number.</summary>
    /// <returns type="String" />
  },
  'keydown': function() {
    /// <signature>
  ...
  'removeAttr': function() {
    ...
    ///   <param name="attributeName" type="String">An attribute to remove; as of _version 1.7, it can be a space-separated list of attributes.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
